...
export const RegistrationPage = () => {
  ...
  return (
    <Content title="Rejestracja" className="ml-40">
      <form onSubmit={handleSubmit} noValidate>
        <div className="max-w-[620px] mb-10 mt-[72px]">
          <h1 className="uppercase text-bazarek-brown-dark font-black text-5xl">
            Rejestracja
          </h1>
          <div className="mt-12 grid grid-rows-3 grid-cols-2 gap-x-4 gap-y-6">
            <TextField
              label="Imie"
              required
              inputProps={{
          ...
          <h3 className="my-9 uppercase text-bazarek-brown-dark font-bold text-sm">
